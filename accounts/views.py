...
def registro_usuario_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Creamos un usuario en la base de datos, con el nombre y password
            # intrucidos por el usuario.
...
def login_view(request):
    ...
    return render(request, 'accounts/login.html', {'mensaje': mensaje, 'username': username})
